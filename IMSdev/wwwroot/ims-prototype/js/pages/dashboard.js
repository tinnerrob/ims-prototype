/* =========================================================
   ...
   Executive dashboard view (KPIs, active orders, alerts).
   ========================================================= */
"use strict";
      ...
      <div class="bento c-8">
        ...
        <div class="bento-body table-wrap">
          <table class="table"><thead><tr><th>Contract</th><th>Project</th><th class="num">Days</th><th class="num">Gross Billing</th><th class="num">Net Profit</th><th class="num">Margin</th></tr></thead><tbody>
            ${active.map(c => { const t = orderTotals(c); return `<tr>
            ...
            </tr>`; }).join("") || `<tr><td colspan="6" class="text-center text-muted2 py-3">No active orders</td></tr>`}
          </tbody></table>
        </div>
      </div>
